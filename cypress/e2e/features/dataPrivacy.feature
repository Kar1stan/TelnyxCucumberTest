Feature: Footer Data & Privacy page

    Feature Data & Privacy page click page button in the Overview button.

    Background:
        Given A web browser is at the telnyx home page and clicks footer Data & Privacy button
    Scenario: Should scroll to the Overview button and click page button
